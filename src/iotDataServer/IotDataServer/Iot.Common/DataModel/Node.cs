...
namespace Iot.Common.DataModel
{
    public class Node
    {
        ...
        public Node(string id = "", PinObject pin = null, Dictionary<string, string> attributes = null, Dictionary<string, string> items = null, List<Node> childNodes = null)
        {
            Id = id;
            Pin = pin?.Clone();
        ...
        public Node(string id, string group, string name = null, PinObject pin = null, Dictionary<string, string> attributes = null, Dictionary<string, string> items = null, List<Node> childNodes = null) : this (id, pin, attributes, items, childNodes)
        {
